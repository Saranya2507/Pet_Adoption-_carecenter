...
<body>
 <div class="sidebar">
    ...
    <div class="content">
         <h1 class="text-center my-4">Suggestions from Admin</h1>
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th>Animal ID</th>
                    <th>Your Tip</th>
                    <th>Suggest from admin</th>
                </tr>
            </thead>
            <tbody>
""")
z=f"""select Animal_id, Suggestion, Tip from suggestion where Care_id ='{careid}'"""
cur.execute(z)
re=cur.fetchall()
if re:
    i = 1
    for suggestion in re:
        animal_id, suggestion_text, tip = suggestion
        print(f"""
            <tr>
                <td>{i}</td>
                <td>{animal_id}</td>
