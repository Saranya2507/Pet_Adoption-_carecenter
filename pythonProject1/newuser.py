...
<body>
    ...
    <div class="content">
        <h1 style="text-align:center;color:skyblue;"> Users</h1>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <center><p><img src="proof/{i[1]}" style="width:50%; height:50vh; margin-top: 10px;"></p></center>
                    <b>Name:</b> {i[2]} {i[3]}<br>
                    <b>Date of Birth:</b>{i[4]}<br>
                    <b>Email:</b> {i[5]}<br>
                    <b>Address:</b> {i[6]}, {i[7]}, {i[8]}, {i[9]}, {i[10]},{i[11]}<br>
                    <b>Username:</b> {i[12]}<br>
                    <b>Password:</b> {i[13]}<br>
